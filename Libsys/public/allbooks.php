...
<div class="container p-5 d-flex justify-content-center">
  <form action="bookadd.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg me-3">Add Book</button>
  </form>
  <form action="changebook.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg me-3">Edit Book</button>
  </form>
  <form action="bookdelete.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg">Delete Book</button>
  </form>
</div>
