...
<div class="container p-5 d-flex justify-content-center">
  <form action="addstd.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg me-3">Add Student</button>
  </form>
  <form action="changestd.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg me-3">Edit Student</button>
  </form>
  <form action="deletestd.php" method="get">
    <button type="submit" class="btn btn-dark btn-lg">Delete Student</button>
  </form>
</div>
